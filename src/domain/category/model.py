...
from sqlalchemy import JSON, DateTime, ForeignKey, String, UUID as SQLAlchemyUUID, UniqueConstraint
...
class Category(Entity):
    ...
    description: Mapped[CategoryDescription] = mapped_column(String(255), default=None)
